...
## The Psych-DS Schema
The Psych-DS Schema is the full set of rules and specifications that you need to follow for your dataset to be Psych-DS compliant. You can find the basic list here in [Psych-DS Rules and Conventions](./rules_and_conventions.md). For guidance in creating your own Psych-DS dataset, see our [Getting Started with Psych-DS](./Guides/1_getting_started/) page. 
