...
Organizing your files and folders doesn't sound like a big deal, but you can save yourself *hundreds of hours* of work by making consistent choices that make it (1) easier for a person (including yourself!) to understand what's going on and (2) easier to use software tools to automate your work, which helps avoid errors and duplicated effort. 
...
*Note: Make sure you keep a backup of your data as it is now, in case you make any mistakes or want to go back!*
...
The important thing will be for you to keep track of what each data file represents! We'll discuss how to do this with file naming below.

*Note: If you are struggling with which files to choose, for now we recommend working with a version of your data that is fully cleaned and processed, those that you would input to a script for statistical analysis or share publicly as the results of the experiment. You can always add additional data files later.*
...
CSVs can be formatted manually or downloaded/exported from any spreadsheet software, such as Excel, Sheets, or Numbers. For Psych-DS, each CSV needs to start with a header row, i.e. a list of the column names. If you open this file in a text editor like Notepad, it will look something like this: 
